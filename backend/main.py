...
from backend.lifecycle import register_lifecycle_events
...
app.include_router(graph.router)  # Phase 15-8-1: 지식 그래프 데이터 API
...
# ============================================
# 라이프사이클 이벤트 등록 (startup/shutdown)
# ============================================
...
_HTML_ROUTES = [
    ...
    ("/knowledge-graph", "knowledge/knowledge-graph.html", "지식 그래프"),
