...
**참조 형식**: [phase-10-navigation.md](../phases/phase-10-navigation.md), [phase-9-navigation.md](../phases/phase-9-navigation.md), [phase-11-navigation.md](../phases/phase-11-navigation.md)  
**버전**: 1.0  
**작성일**: 2026-02-04
...
아래 섹션은 **필수**이며, [phase-10-navigation.md](../phases/phase-10-navigation.md), [phase-11-navigation.md](../phases/phase-11-navigation.md)와 동일한 순서·제목을 유지한다.
...
| 문서 | 용도 |
|------|------|
| [04-rules-and-conventions.md](../README/04-rules-and-conventions.md) | 룰·규약 인덱스 — 본 규칙 링크 등록 |
| [phase-10-navigation.md](../phases/phase-10-navigation.md) | 형식·섹션 순서 참조 |
| [phase-9-navigation.md](../phases/phase-9-navigation.md) | 형식·의존성 그래프 참조 |
| [phase-11-navigation.md](../phases/phase-11-navigation.md) | Phase 11 적용 예시 |
