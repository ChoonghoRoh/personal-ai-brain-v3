...
**기준 문서**: [ai-rule-decision.md](ai-rule-decision.md), [phase-document-taxonomy.md](../phase-document-taxonomy.md)
**버전**: 1.0
**작성일**: 2026-02-05
...
- **Phase 단위 Task 수행 리포트**: Phase 내 여러 Task를 한 문서에서 정리할 때 `phase-X-Y-task-report.md` 사용 (예: [phase-10-1-task-report.md](../phases/phase-10-1/phase-10-1-task-report.md)).
...
| [phase-document-taxonomy.md](../phase-document-taxonomy.md)                                | Phase·Task 문서 종류·파일명·저장 위치                       |
...
| [docs/webtest/README.md](../webtest/README.md)                                             | webtest 인덱스·순차 진행 (Task 검사 완료 후 §6 연결)        |
| [docs/webtest/phase-unit-user-test-guide.md](../webtest/phase-unit-user-test-guide.md)     | Phase 단위 유저 테스트 3가지 방안·webtest: X-Y start        |
| [docs/webtest/phase-10-test-scenario-guide.md](../webtest/phase-10-test-scenario-guide.md) | Phase 10-1·10-2 E2E + MCP 시나리오(Task당 10개) 순차 가이드 |
...
- **webtest 인덱스**: [docs/webtest/README.md](../webtest/README.md) — 테스트 시나리오 가이드 순차 진행(Index) 참고.
- **Phase 10-1·10-2**: E2E 실행 후 [phase-10-test-scenario-guide.md](../webtest/phase-10-test-scenario-guide.md)에 따라 MCP 시나리오 .md(Task당 10개) 기준으로 실행하고, [phase-10-1-mcp-webtest-result.md](../webtest/phase-10-1/phase-10-1-mcp-webtest-result.md) 등에 결과 기록.
