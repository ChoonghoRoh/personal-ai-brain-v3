# Frontend Developer Charter (4th SSOT)
...
**4th SSOT**: 본 문서는 [ROLES/frontend-dev.md](../ROLES/frontend-dev.md), [2-architecture.md](../2-architecture.md)와 함께 사용. 단독 사용 시 본 iterations/4th 세트만 참조.
