...
**팀원 이름**: `backend-dev` | **Charter**: [BACKEND.md](../../rules/role/BACKEND.md) | **코드 편집**: ✅
...
**팀원 이름**: `frontend-dev` | **Charter**: [FRONTEND.md](../../rules/role/FRONTEND.md) | **코드 편집**: ✅
...
**팀원 이름**: `verifier` | **Charter**: [QA.md](../../rules/role/QA.md) | **코드 편집**: ❌
...
**팀원 이름**: `tester` | **Charter**: [QA.md](../../rules/role/QA.md) | **코드 편집**: ❌
...
**실행**: 메인 세션 | **Charter**: [LEADER.md](../../rules/role/LEADER.md) | **코드 편집**: ❌
...
- 기반: 0-entrypoint.md (1st iteration, 612줄)
