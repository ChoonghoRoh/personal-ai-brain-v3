...
**API 검증**(Task report 기반, 샘플 데이터·2차 점검 기록)은 → [phase-9-1-api-verification-checklist.md](phase-9-1-api-verification-checklist.md)

**테스트 전 환경 구축** (백엔드 기동, Base URL, Docker/Playwright/MCP 브라우저) → [docs/webtest/web-user-test-setup-guide.md](../../webtest/web-user-test-setup-guide.md)
