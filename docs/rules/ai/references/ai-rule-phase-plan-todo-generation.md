...
**참조 형식**: [common/common-phase-10-1-0-plan.md](../../common/references/common-phase-10-1-0-plan.md), [common/common-phase-10-1-0-todo-list.md](../../common/references/common-phase-10-1-0-todo-list.md), [common/common-phase-9-1-todo-list.md](../../common/references/common-phase-9-1-todo-list.md)
**버전**: 1.0
**작성일**: 2026-02-04
...
**Phase 명**: <Phase 명>
**Z**: 0 (초기 설계)
**기준 문서**: `phase-X-master-plan.md`
**명명 규칙**: [ai-rule-phase-naming.md](ai-rule-phase-naming.md)
```
...
- **필수 링크**: `phase-X-master-plan.md`, `phase-X-Y-0-todo-list.md` (또는 해당 todo-list 파일명).
...
| 경로                                                                                                | 용도                                           |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| [common/common-phase-10-1-0-plan.md](../../common/references/common-phase-10-1-0-plan.md)           | Plan 형식·§1~§5 구조                           |
| [common/common-phase-10-1-0-todo-list.md](../../common/references/common-phase-10-1-0-todo-list.md) | Todo-List 형식·Phase 진행 정보·Task 목록       |
| [common/common-phase-10-2-0-plan.md](../../common/references/common-phase-10-2-0-plan.md)           | Task 개요 표·Validation                        |
| [common/common-phase-10-4-0-plan.md](../../common/references/common-phase-10-4-0-plan.md)           | 선택 Phase·Out of Scope                        |
| [common/common-phase-9-1-todo-list.md](../../common/references/common-phase-9-1-todo-list.md)       | Todo-List 변형(phase-X-Y-todo-list.md, Z 없음) |
| [common/common-phase-9-3-todo-list.md](../../common/references/common-phase-9-3-todo-list.md)       | Phase 진행 정보·Task 체크리스트 세부           |
...
| 문서                                                                             | 용도                                                            |
| -------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| [../../rules-index.md](../../rules-index.md)                                     | 통합 Rules 인덱스 — 본 규칙·[phase-x-plan-todo:make] 링크 등록  |
