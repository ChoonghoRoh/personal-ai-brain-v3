...
**기준 문서**: [common/common-phase-document-taxonomy.md](../../common/references/common-phase-document-taxonomy.md) §2.4, [ai-rule-decision.md](ai-rule-decision.md) §2·§4, [ai-rule-phase-naming.md](ai-rule-phase-naming.md) §7, [ai-rule-task-inspection.md](ai-rule-task-inspection.md) §3
**참고 결과물**: [ai/references/](.), [ai/references/ai-example-phase-10-2-tasks-readme.md](ai-example-phase-10-2-tasks-readme.md)
**버전**: 1.0
**작성일**: 2026-02-04
...
| 조건                     | 내용                                                                                                                                                                                                                  |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **유도 원천**            | Task 문서는 **todo-list에서 유도된 항목**에 대해서만 생성. [common/common-phase-document-taxonomy.md](../../common/references/common-phase-document-taxonomy.md) §2.4, [ai-rule-decision.md](ai-rule-decision.md) §4. |
...
**기반 문서**: `phase-X-Y-0-todo-list.md`
**Plan**: `phase-X-Y-0-plan.md`
**작업 순서**: `phase-X-navigation.md` (있을 경우)
```
...
| Phase    | 경로                                                                                         | Task 문서 예시                                                                                                     |
| -------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **10-1** | [ai/references/ai-example-phase-10-1-tasks-readme.md](ai-example-phase-10-1-tasks-readme.md) | ai-example-task-10-1-1-_.md, ai-example-task-10-1-2-_.md, ai-example-task-10-1-3-\*.md                             |
| **10-2** | [ai/references/ai-example-phase-10-2-tasks-readme.md](ai-example-phase-10-2-tasks-readme.md) | ai-example-task-10-2-1-_.md, ai-example-task-10-2-2-_.md, ai-example-task-10-2-3-_.md, ai-example-task-10-2-4-_.md |
...
| [common/common-phase-document-taxonomy.md](../../common/references/common-phase-document-taxonomy.md) §2.4 | Task 문서 종류·파일명·생성 주체                  |
