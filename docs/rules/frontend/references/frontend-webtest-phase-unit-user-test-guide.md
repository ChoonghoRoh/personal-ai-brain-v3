...
| 항목          | 내용                                                                                                                                                                                                                                                                             |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **전제**      | [frontend-webtest-setup-guide.md](frontend-webtest-setup-guide.md) 3.3절 — 백엔드 Base URL 기동, Cursor와 브라우저 MCP가 같은 호스트에서 동작하면 `http://localhost:8000` 접근 가능                                                                                              |
...
| 항목          | 내용                                                                                                                                                                                                                                                                                                                                           |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **전제**      | [frontend-webtest-setup-guide.md](frontend-webtest-setup-guide.md) 3.2절 — `baseURL: 'http://localhost:8000'`, 필요 시 `webServer`로 테스트 전 백엔드 기동                                                                                                                                                                                     |
...
**템플릿**: [\_template/phase-X-Y-user-test-plan.md](../../../webtest/_template/phase-X-Y-user-test-plan.md)를 복사한 뒤 phase 번호와 이름을 치환해 사용할 수 있습니다.
