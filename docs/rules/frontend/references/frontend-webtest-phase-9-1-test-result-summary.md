...
**대상**: Phase 9-1 보안 강화
**테스트 기준**: [frontend-phase-9-1-web-user-checklist.md](./frontend-phase-9-1-web-user-checklist.md)
**가이드**: [frontend-webtest-phase-unit-user-test-guide.md](frontend-webtest-phase-unit-user-test-guide.md)
...
| **방안 B: 페르소나**         | ❌ 미수행 | 관점별(기획자/개발자/UI·UX) 테스트는 MCP 또는 수동으로 수행 시 [frontend-webtest-personas.md](frontend-webtest-personas.md) + 관점별 prompt 참고.         |
...
1. **[MCP Cursor 테스트 수행 가이드](frontend-webtest-mcp-cursor-test-guide.md)** 에서 Cursor 브라우저 활성화 방법과 지시문 예시를 확인합니다.
2. Cursor Agent에서 [frontend-webtest-mcp-cursor-test-guide.md](frontend-webtest-mcp-cursor-test-guide.md) 의 Phase 9-1 프롬프트를 복사해 체크리스트 문서를 @로 붙이고 지시합니다.
3. 관점별(기획자/개발자/UI·UX) 기록이 필요하면 [frontend-webtest-personas.md](frontend-webtest-personas.md)와 해당 [docs/webtest/prompts/](../../../webtest/prompts/) 문서를 함께 전달합니다.
