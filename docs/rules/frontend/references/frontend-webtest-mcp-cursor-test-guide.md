...
| 항목                  | 내용                                                                                                                           |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **백엔드 기동**       | [frontend-webtest-setup-guide.md](frontend-webtest-setup-guide.md) 2절 — `docker-compose up -d` 또는 `uvicorn ... --port 8000` |
...
4. (선택) 관점별 기록이 필요하면 [frontend-webtest-personas.md](frontend-webtest-personas.md)와 [docs/webtest/prompts/](../../../webtest/prompts/) 중 하나를 함께 붙이고 **기획자/개발자/UI·UX** 관점으로 기록하라고 지시한다.
5. 결과는 체크리스트의 **결과/비고**란 형식이나 [phase-x-y-web-user-test-report](frontend-webtest-phase-unit-user-test-guide.md) 형식으로 정리하도록 요청한다.
...
```
@docs/rules/frontend/references/frontend-phase-9-1-web-user-checklist.md
@docs/rules/frontend/references/frontend-webtest-personas.md
@docs/rules/frontend/references/frontend-webtest-prompt-planner.md

위 문서를 참고해서 phase-9-1 웹 체크리스트를 가상 브라우저에서 순서대로 수행해 줘.
꼼꼼한 기획자 관점으로 발견 사항(요구사항·플로우·안내 문구)을 기록해 줘.
```

**개발자 관점:** `frontend-webtest-prompt-planner.md` 대신 `@docs/rules/frontend/references/frontend-webtest-prompt-developer.md`
**UI·UX 관점:** `@docs/rules/frontend/references/frontend-webtest-prompt-uiux-designer.md`
...
| -------- | --------------------------------------- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| **10-1** | `python3 scripts/webtest.py 10-1 start` | [frontend-webtest-phase-10-1-mcp-scenarios.md](frontend-webtest-phase-10-1-mcp-scenarios.md) (30개) | [frontend-webtest-phase-10-1-mcp-result.md](frontend-webtest-phase-10-1-mcp-result.md) |
| **10-2** | `python3 scripts/webtest.py 10-2 start` | [frontend-webtest-phase-10-2-mcp-scenarios.md](frontend-webtest-phase-10-2-mcp-scenarios.md) (40개) | [frontend-webtest-phase-10-2-mcp-result.md](frontend-webtest-phase-10-2-mcp-result.md) |

- **순차 가이드**: [frontend-webtest-phase-10-test-scenario-guide.md](frontend-webtest-phase-10-test-scenario-guide.md).
...
각 phase별 MCP 시나리오 문서에 프롬프트 예시가 정리되어 있습니다. 위 관점별 prompt 파일들을 함께 참고하면 됩니다.
...
- 해당 Cursor 세션에서 브라우저 MCP가 등록되지 않은 상태일 수 있습니다. (예: [phase-9-3-report-developer.md](../../../webtest/phase-9-3/reports/phase-9-3-report-developer.md) 참고)
- **대안**: [방안 C: E2E](frontend-webtest-phase-unit-user-test-guide.md) 로 `[webtest: X-Y start]` 명령을 실행해 Playwright E2E로 동일 체크리스트를 자동 실행할 수 있습니다.
...
| 문서                                                                                             | 용도                                                   |
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------ |
| [frontend-webtest-phase-unit-user-test-guide.md](frontend-webtest-phase-unit-user-test-guide.md) | 3가지 방안( MCP·페르소나·E2E ) 요약 및 리포트 프로세스 |
| [frontend-webtest-setup-guide.md](frontend-webtest-setup-guide.md)                               | 백엔드 기동, Base URL, E2E/MCP 전제 조건               |
| [frontend-webtest-personas.md](frontend-webtest-personas.md)                                     | 페르소나·관점별 기록 가이드                            |
