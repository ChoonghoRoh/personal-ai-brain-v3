...
| 문서                                                                                   | 용도                                               |
| -------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [frontend-phase-9-3-web-user-checklist.md](./frontend-phase-9-3-web-user-checklist.md) | 웹 시나리오 체크리스트 (메뉴별 시나리오·결과/비고) |
| (Phase 9-3 API 검증 체크리스트는 rules/common 또는 원본 참고용)                        | API 검증 (참고용)                                  |
...
[frontend-rule-phase-unit-user-test-guide.md](./frontend-rule-phase-unit-user-test-guide.md)에 따릅니다.

1. 본 테스트 계획에서 범위·목표·시나리오 확인
2. [frontend-phase-9-3-web-user-checklist.md](./frontend-phase-9-3-web-user-checklist.md) 체크리스트대로 브라우저에서 실행
...
- **상세**: [frontend-webtest-setup-guide.md](frontend-webtest-setup-guide.md) 3.2절
...
| 문서                                                                           | 용도                                                  |
| ------------------------------------------------------------------------------ | ----------------------------------------------------- |
| **[frontend-webtest-phase-9-3-final-summary.md](frontend-webtest-phase-9-3-final-summary.md)**                   | 개발·테스트 최종 보고 (3관점 통합, 액션 아이템, 결론) |
| [reports/phase-9-3-report-planner.md](../../../webtest/phase-9-3/reports/phase-9-3-report-planner.md)     | 꼼꼼한 기획자 관점 상세                               |
| [reports/phase-9-3-report-developer.md](../../../webtest/phase-9-3/reports/phase-9-3-report-developer.md) | 개발자 관점 상세                                      |
| [reports/phase-9-3-report-uiux.md](../../../webtest/phase-9-3/reports/phase-9-3-report-uiux.md)           | UI·UX 디자이너 관점 상세                              |
