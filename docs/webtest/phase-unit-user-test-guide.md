...
| 항목          | 내용                                                                                                                                                                                                                                           |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **전제**      | [web-user-test-setup-guide.md](web-user-test-setup-guide.md) 3.3절 — 백엔드 Base URL 기동, Cursor와 브라우저 MCP가 같은 호스트에서 동작하면 `http://localhost:8001` 접근 가능                                                                  |
...
| 항목          | 내용                                                                                                                                                                                                                                                                                                                                           |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **전제**      | [web-user-test-setup-guide.md](web-user-test-setup-guide.md) 3.2절 — `baseURL: 'http://localhost:8001'`, 필요 시 `webServer`로 테스트 전 백엔드 기동                                                                                                                                                                                           |
