...
**기준**: [phase-10-1-0-plan.md](../../phases/phase-10-1/phase-10-1-0-plan.md), [phase-10-1-0-todo-list.md](../../phases/phase-10-1/phase-10-1-0-todo-list.md)  
**MCP**: cursor-ide-browser / cursor-browser-extension  
**상세 시나리오**: [phase-10-1-mcp-webtest-scenarios.md](phase-10-1-mcp-webtest-scenarios.md) — **Task당 10개, 총 30개**
...
Task당 **10개** 시나리오, **총 30개**. 상세 조치·기대 결과·검증 방법은 [phase-10-1-mcp-webtest-scenarios.md](phase-10-1-mcp-webtest-scenarios.md) 참고.
...
- 상세 30개 시나리오는 [phase-10-1-mcp-webtest-scenarios.md](phase-10-1-mcp-webtest-scenarios.md)에서 조치·기대 결과·검증 방법 확인.
